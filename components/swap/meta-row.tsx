      ...
      <View className="flex-row items-center gap-1.5">
        ...
        {badge && (
          <View className="bg-emerald-50 px-2 py-[3px] rounded-md">
            <Text className="text-[10px] font-bold text-emerald-600 tracking-wide">{badge}</Text>
          </View>
        )}
      </View>
      <Text className="text-[13px] text-gray-900 font-medium tracking-wide">{value}</Text>
    </View>
  );
}
